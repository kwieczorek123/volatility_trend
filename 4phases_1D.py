...
file_names_pivots_long = ['results/trend_volatility_results/processed_CI_data/EURUSD_CI_D1.csv', 'results/trend_volatility_results'
...
interval = 'D1'  # Change this to 'D1', 'H4', 'H1', or 'all'
if interval == 'all':
