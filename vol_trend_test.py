...
create_pivot_tables_and_charts([
    "processed_CI_test_data/processed_EURUSD_CI_test.csv",
    "processed_CI_test_data/processed_GBPUSD_CI_test.csv",
    "processed_CI_test_data/processed_USDJPY_CI_test.csv",
    "processed_CI_test_data/processed_XAUUSD_CI_test.csv"
])

create_pivot_tables_and_charts_long([
    "processed_CI_test_data/processed_EURUSD_CI_test_long.csv",
    "processed_CI_test_data/processed_GBPUSD_CI_test_long.csv",
    "processed_CI_test_data/processed_USDJPY_CI_test_long.csv",
    "processed_CI_test_data/processed_XAUUSD_CI_test_long.csv"
])
